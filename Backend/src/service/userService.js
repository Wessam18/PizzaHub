...
var SendVrifyMail_1 = require("../MiddleWares/SendVrifyMail");
...
var register = function (_a) {
    var name = _a.name, email = _a.email, phoneNumber = _a.phoneNumber, password = _a.password;
...
var updateUser = function (_a) {
    var userId = _a.userId, name = _a.name, email = _a.email, phoneNumber = _a.phoneNumber, currentPassword = _a.currentPassword, newPassword = _a.newPassword;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, nameRegex, emailRegex, existingEmailUser, phoneRegex, existingPhoneUser, isMatch, passwordRegex, _b, token, error_2;
